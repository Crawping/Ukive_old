...
TextView::TextView(UWindow *wnd, int id)
	:View(wnd, id),
	mTextColor(D2D1::ColorF::Black),
	mSelectionBackgroundColor(D2D1::ColorF::SkyBlue)
{
...
void TextView::onDraw(UCanvas *canvas)
{
	if (mIsSelectable)
	{
...
bool TextView::onInputEvent(UInputEvent *e)
{
	View::onInputEvent(e);
...
UInputConnection *TextView::onCreateInputConnection()
{
...
UEditable *TextView::getEditable()
{
	return mBaseText;
}
...
URectF TextView::getSelectionBound(unsigned int start, unsigned int end)
{
	if (end < start)
		return URectF();
...
void TextView::computeVisibleRegion(URectF *visibleRegon)
{
...
bool TextView::onCreateActionMode(TextActionMode *mode, UMenu *menu)
{
	if (this->canCopy())
...
bool TextView::onPrepareActionMode(TextActionMode *mode, UMenu *menu)
{
...
bool TextView::onActionItemClicked(TextActionMode *mode, UMenuItem *item)
{
