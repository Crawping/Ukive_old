...
class UWallpaperTransform;

enum UWALLPAPER_EFFECT_PROP
{
	UWALLPAPER_EFFECT_PROP_OFFSET = 0
};
...
class UWallpaperEffect : public ID2D1EffectImpl
{
private:
	// 构造函数必须私有以保证其不被外界调用。
	UWallpaperEffect();
	...
	LONG mRefCount;
	UWallpaperTransform *mTransform;
