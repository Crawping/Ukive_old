...
UWallpaperTransform::UWallpaperTransform()
	:mRefCount(1)
{
	mInputRect.left = 100;
	mInputRect.top = 100;
...
IFACEMETHODIMP_(UINT32) UWallpaperTransform::GetInputCount() const
{
	return 0;
}

IFACEMETHODIMP UWallpaperTransform::MapInputRectsToOutputRect(
...
IFACEMETHODIMP UWallpaperTransform::MapOutputRectToInputRects(
...
IFACEMETHODIMP UWallpaperTransform::MapInvalidRect(
	UINT32 inputIndex,
...
IFACEMETHODIMP UWallpaperTransform::SetDrawInfo(
...
IFACEMETHODIMP_(ULONG) UWallpaperTransform::AddRef()
{
	return InterlockedIncrement(&mRefCount);
}

IFACEMETHODIMP_(ULONG) UWallpaperTransform::Release()
{
...
IFACEMETHODIMP UWallpaperTransform::QueryInterface(REFIID riid, _Outptr_ void** ppOutput)
{
	if (ppOutput == nullptr)
		return E_INVALIDARG;
