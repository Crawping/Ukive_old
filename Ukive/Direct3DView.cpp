...
Direct3DView::Direct3DView(UWindow *wnd)
	:View(wnd)
{
	initDirect3DView();
}

Direct3DView::Direct3DView(UWindow *wnd, int id)
	: View(wnd, id)
{
	initDirect3DView();
}
...
void Direct3DView::onDraw(UCanvas *canvas)
{
	View::onDraw(canvas);
}

bool Direct3DView::onInputEvent(UInputEvent *e)
{
	View::onInputEvent(e);
...
TerrainScene *Direct3DView::getTerrainScene()
{
	return mScene;
}